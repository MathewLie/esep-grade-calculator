...
func (gc *GradeCalculator) calculateNumericalGrade() int {
	...
	// Error found here, originally was computing average of exams twice. Changed to essays.
...
func computeAverage(grades []Grade) int {
	...
	// For loop is summing up the index rather than the grades, changed to iterate and add over the grades.
